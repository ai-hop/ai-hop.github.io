...
export const providers = [
  {
    ...
    status: 'recommended',
    rating: 4,
    benefits: ['注册送175刀', { text: '每日登录送25刀', expired: false }],
  ...
  },
  {
    id: 'motomoto',
    name: 'MotoMoto',
    url: 'https://motomoto.lol/sign-up?aff=FcrQ',
    category: 'public',
    status: 'recommended',
    rating: 3,
    benefits: ['注册赠送30刀', '每日签到随机金额'],
  ...
  },
  {
    id: 'aipm',
    name: 'AIPM',
    url: 'https://emtf.aipm9527.online/sign-up?aff=31W8',
    category: 'paid',
    status: 'average',
    rating: 3,
    tags: ['低倍率'],
    benefits: ['新用户注册赠送0.48刀', '使用邀请码额外赠送0.48刀', '进群领取0.96刀'],
    models: ['claude-sonnet-4-6'],
    modelTypes: ['Claude'],
    benefitTypes: ['注册赠送', '邀请返利', '低倍率', '其他'],
    benefitVerifiedAt: '2026-09-02',
    rates: [
      { model: 'claude', rate: '0.025x' },
    ],
    requirements: '限制：没有最新模型',
    note: '',
  },
  {
    id: 'docode',
